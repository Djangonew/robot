...
NISKALA_IMG = "https://telegra.ph/file/2e29bb4dedeb7f9f6b254.jpg"

PM_START_TEXT = """
*ʜᴇʟʟᴏ {}, ɪ'ᴍ ғᴇɪᴛᴀɴ!*
✪ `ɪ'ᴍ ᴀɴ ᴀɴɪᴍᴇ-ᴛʜᴇᴍᴇ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʀᴏʙᴏᴛ​` [✨](https://telegra.ph/file/2e29bb4dedeb7f9f6b254.jpg)
────────────────────
× *Uᴘᴛɪᴍᴇ:* `{}`
× `{}` *Uꜱᴇʀ, Aᴄʀᴏꜱꜱ* `{}` *Cʜᴀᴛꜱ.*
────────────────────
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Ok I've been active!")
        except Unauthorized:
            LOGGER.warning(
